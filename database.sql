...
-- Dumping data for table tdk_petshop.category: ~3 rows (approximately)
...
-- Dumping data for table tdk_petshop.chitiethoadon: ~19 rows (approximately)
...
INSERT INTO `hoadon` (`Id`, `Day`, `UserId`, `Total`, `Address`) VALUES
	...
	('642252a789075', '2023-03-28 09:36:23', 1, 100000, '100/25/35b trần hưng đạo');
...
-- Dumping data for table tdk_petshop.product: ~9 rows (approximately)
DELETE FROM `product`;
INSERT INTO `product` (`Id`, `Name`, `Price`, `Image`, `Quantity`, `Unit`, `CategoryId`) VALUES
	(1, 'Benefits', 100000, '6404d04f85384.jpg', 89, 'Hộp', 1),
...
INSERT INTO `user` (`Id`, `UserName`, `Pass`, `FullName`, `Avata`, `RoleId`, `Token`, `Email`, `Status`) VALUES
	(1, 'khuongzxc123', '$2y$10$uAo06Dorh2Ly05zjMyTGb.OjTix8OOJDAETybUKSlhmIHqRGZOKbG', 'Trần Văn Khương', '64225bf3d898e.jpg', 1, NULL, NULL, 0),
	(2, 'hugoloc1005', '$2y$10$uWqXxqQLKKytU5iNp.7aDum5APFShR26FoNbZ5MkBjuhHW5/yRBrC', 'Thú Ăn Tái', '6406f990ab24c.png', 2, '904046', 'hugoloc1005@gmail.com', 1),
